...
confirmationMessageElement.textContent = `Great! You have chosen ${selectedAssistant}! Click 'Get started' to proceed.`;confirmationMessageElement.style.color = "green";
...
// Added an event listener to the continue button
